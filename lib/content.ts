import { JSONContent } from "@/lib/editor-core";
  ...
  content: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "text",
          text: " is a Notion-style WYSIWYG editor with AI-powered autocompletions. Built with ",
        },
        {
          type: "text",
          marks: [
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          text: 'import Editor from "@/components/tailwind/editor";\n\nexport default function App() {\n  return (\n     <Editor />\n  )\n}',
        },
      ],
    },
    {
    ...
    },
    {
      type: "image",
      attrs: {
        src: "https://public.blob.vercel-storage.com/pJrjXbdONOnAeZAZ/banner-2wQk82qTwyV1vlglvwY1ppJVKc3N5J.png",
        alt: "banner.png",
        title: "banner.png",
        width: 718,
        height: 404,
