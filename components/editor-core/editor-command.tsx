...
import { queryAtom, setRangeAtom } from "@/lib/editor-utils/atoms";
import { novelStore } from "@/lib/editor-utils/store";
...
export const EditorCommandOut: FC<EditorCommandOutProps> = ({ query, range }) => {
  ...
  const setRange = useSetAtom(setRangeAtom, { store: novelStore });
